...
class AdditiveMonoid(BaseTests):
    ...
    def test_201_additive_identity(self, a: ClassUnderTest) -> None:
...
class FieldTests(AdditiveMonoid):
    ...
    def test_202_addition_inverse(self, a: ClassUnderTest) -> None:
        self.assertEqual(a + (-a), self.zero)

    def test_203_addition_commutativity(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        self.assertEqual(a + b, b + a)

    def test_210_multiplication_associativity(self, a: ClassUnderTest, b: ClassUnderTest, c: ClassUnderTest) -> None:
        self.assertEqual(a * (b * c), (a * b) * c)

    def test_211_multiplicative_identity(self, a: ClassUnderTest) -> None:
        self.assertEqual(a * self.one, a)
        self.assertEqual(self.one * a, a)

    def test_212_multiplication_commutativity(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        self.assertEqual(a * b, b * a)
    ...
    def test_230_pos_definition(self, a: ClassUnderTest) -> None:
        self.assertEqual(+a, a)

    def test_240_sub_definition(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        self.assertEqual(a - b, a + (-b))

    def test_250_truediv_definition(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        assume(b != self.zero)
        calc = (a / b) * b
...
class FloorDivModTests(BaseTests):
    ...
    def test_260_mod_range(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        assume(b != self.zero)
        rem = a % b
        if b <= self.zero:
    ...
    def test_261_floordiv_definition(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        assume(b != self.zero)
        self.assertEqual((a // b) * b + a % b, a)

    def test_262_divmod_definition(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        assume(b != self.zero)
...
class ExponentiationTests(BaseTests):
    ...
    def test_270_exponentiation_zero_by_zero(self) -> None:
        # By Python defintion (Standard Library §4.4 note 5)
        self.assertEqual(self.zero ** self.zero, self.one)

    def test_271_exponentiation_by_zero(self, a: ClassUnderTest) -> None:
        assume(a != self.zero)
        self.assertEqual(a ** self.zero, self.one)

    def test_272_exponentiation_with_base_zero(self, a: ClassUnderTest) -> None:
        assume(a > self.zero)
        self.assertEqual(self.zero ** a, self.zero)

    def test_273_exponentiation_with_base_one(self, a: ClassUnderTest) -> None:
        assume(a != self.zero)
        self.assertEqual(self.one ** a, self.one)

    def test_274_exponentiation_by_one(self, a: ClassUnderTest) -> None:
        assume(a != self.zero)
        self.assertEqual(a ** self.one, a)
...
class AbsoluteValueTests(BaseTests):
    ...
    def test_400_abs_not_negative(self, a: ClassUnderTest) -> None:
        self.assertTrue(self.real_zero <= abs(a))

    def test_401_abs_positve_definite(self, a: ClassUnderTest) -> None:
        self.assertEqual(abs(a) == self.real_zero, a == self.zero)

    def test_402_abs_one_is_one(self) -> None:
        self.assertEqual(abs(self.one), self.one)

    def test_410_abs_is_multiplicitive(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
...
class ConjugateTests(BaseTests):
    ...
    def test_420_conjugate_is_additive(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        self.assertEqual((a + b).conjugate(), a.conjugate() + b.conjugate())

    def test_421_conjugate_is_multiplicitive(self, a: ClassUnderTest, b: ClassUnderTest) -> None:
        self.assertEqual((a * b).conjugate(), a.conjugate() * b.conjugate())

    def test_422_conjugate_has_same_absolute_value(self, a: ClassUnderTest) -> None:
        self.assertEqual(abs(a.conjugate()), abs(a))

    def test_423_conjugate_has_same_real_value(self, a: ClassUnderTest) -> None:
        self.assertEqual(a.conjugate().real, a.real)

    def test_424_conjugate_has_negated_imag_value(self, a: ClassUnderTest) -> None:
        self.assertEqual(a.conjugate().imag, -a.imag)

    def test_425_imag_is_zero_iff_conjugate_equals_self(self, a: ClassUnderTest) -> None:
        self.assertEqual(a == a.conjugate(), a.imag == self.real_zero)

    def test_426_absolute_value_real_and_imag_values(self, a: ClassUnderTest) -> None:
        self.assertEqual(abs(a) * abs(a), a.real * a.real + a.imag * a.imag)


class RoundingTests(BaseTests):

    def test_430_round_is_integral(self, a: ClassUnderTest) -> None:
        self.assertEqual(float(round(a)) % 1.0, 0.0)

    def test_431_round_is_close(self, a: ClassUnderTest) -> None:
        self.assertLessEqual(abs(float(a) - float(round(a))), 0.5)

    def test_432_round_towards_even(self, a: ClassUnderTest) -> None:
    ...
    def test_435_floor_definition(self, a: ClassUnderTest) -> None:
    ...
    def test_436_ceil_definition(self, a: ClassUnderTest) -> None:
        a_ceil = math.ceil(a)
    ...
    def test_437_trunc_definition(self, a: ClassUnderTest) -> None:
...
class QuotientTests(BaseTests):
    ...
    def test_443_lowest_terms(self, a: ClassUnderTest) -> None:
        assume(a != self.zero)
